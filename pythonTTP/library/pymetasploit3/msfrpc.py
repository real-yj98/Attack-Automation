...
from library.pymetasploit3.utils import *
import requests
import uuid
import time
import re
...
class MeterpreterSession(MsfSession):
    ...
    def runsingle(self, data):
        """print
        Run a single meterpreter commandprint
print
        Mandatory Arguments:
...
class MsfConsole(object):
    ...
    def run_module_with_output_background(self, mod, payload=None):
        """
    ...
    def run_server_with_output(self, mod, payload=None):
        """
        Execute a module and wait for the returned data
